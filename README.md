...
<p align="center"><strong><a href="https://github.com/menottim/splintarr/releases/tag/v1.0.1-alpha">Version 1.0.1-alpha</a></strong> | Automated backlog search for Sonarr, designed for homelab use.</p>
